...
截至 2026-07-31，M0–M3 已完成。系统已具备 Project 发现/扫描、资产与不可变修订、关系、多供应商模型路由、持久生成计划、硬 QA、人工审核、Release Manifest v2，以及面向游戏 checkout 的可恢复 Delivery；Web 制作台已接入真实 Project 数据，并提供生成计划、运行检查器和 Release 交付面板。
...
尚未完成的是 M4 的 Codex 监督 Agent、自动语义诊断和 ChangeSet，以及 M5 真实游戏试点。Provider 返回图片不等于批准、Release 或 Delivery；Delivery 仍要求用户明确选择 checkout、Release 和验证动作。
